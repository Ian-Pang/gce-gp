...
class NFWTemplate:
    def __init__(self, nside=128, outer=30.0, n_integ=500, rsun=8.224, r_s=20.0, r_norm=30.0, custom_mask = None):
        """Generate HEALPix map of NFW template
        Ed Update: Wanted normalization mask of NFW to match normalization mask of rest of template, so added
        custom_mask option (in a backwards-compatible way)
        Args:
